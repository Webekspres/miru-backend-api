...
## Corpus Check
- 129 files · ~70,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1781 nodes · 2917 edges · 171 communities (88 shown, 83 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 636 edges (avg confidence: 0.52)
...
1. `♻` - 76 edges
2. `EnvelopeAPITestCase` - 69 edges
3. `success_response()` - 58 edges
4. `KategoriSampah` - 57 edges
5. `AlreadyProcessedError` - 48 edges
6. `TransaksiSetoran` - 37 edges
7. `Command` - 36 edges
8. `User` - 32 edges
9. `Reward` - 30 edges
10. `PenarikanSaldo` - 28 edges
...
- `MiruTokenObtainPairSerializer` --uses--> `LoginAnonRateThrottle`  [INFERRED]
...
Cohesion: 0.11
Nodes (27): DetailSetoran, Decimal, KategoriSampah, User, adjust_setoran_correction(), create_setoran_with_side_effects(), credit_nasabah_setoran(), debit_nasabah_poin() (+19 more)

### Community 1 - "Services 1"
Cohesion: 0.12
Nodes (15): DashboardDepositChartView, DashboardOverviewView, DashboardRecentActivityView, InventoryHistoryView, InventoryView, MonitorView, Monitoring endpoints: dashboard (Modul 15), laporan (Modul 16), inventory (Modul, Base view for admin/koordinator/pemerintah read-only monitoring. (+7 more)

### Community 2 - "Backend"
Cohesion: 0.22
Nodes (10): MeView, MiruTokenObtainPairSerializer, MiruTokenObtainPairView, MiruTokenRefreshView, user_auth_payload(), UserProfileSerializer, Response, TokenObtainPairSerializer (+2 more)
...
### Community 4 - "Tests"
Cohesion: 0.07
Nodes (23): Meta, Notifikasi, PenarikanSaldo, Pengaduan, Penjemputan, PenukaranPoin, In-app notification untuk user nasabah., Reward (+15 more)

### Community 6 - "Tests 6"
Cohesion: 0.06
Nodes (65): InvalidStatusTransitionError, PenjemputanUpdateSerializer, Decimal, User, APIException, date, datetime, Penjemputan (+57 more)
...
Cohesion: 0.12
Nodes (15): AlreadyProcessedError, DetailSetoranReadSerializer, DetailSetoranSerializer, DetailSetoranWriteSerializer, Meta, MitraPengepulSerializer, NasabahLookupSerializer, PenarikanSaldoUpdateSerializer (+7 more)

### Community 10 - "Backend 10"
Cohesion: 0.16
Nodes (6): IsAdminOrKoordinator, IsPemerintahReadOnly, Pemerintah distrik: hanya boleh akses read (GET/HEAD/OPTIONS)., PenjualanMitraSerializer, MitraPengepulViewSet, PenjualanMitraViewSet
...
Cohesion: 0.10
Nodes (7): NotifikasiAdmin, PengaturanInstitusiAdmin, PengumumanAdmin, RiwayatHargaAdmin, PengaturanInstitusi, Singleton — profil institusi bank sampah (pk selalu 1)., InstitutionSettingsTests

### Community 15 - "Services 15"
Cohesion: 0.22
Nodes (15): MitraPengepul, PenjualanMitra, PenjualanMitraCreateSerializer, Decimal, KategoriSampah, MitraPengepul, PenjualanMitra, InsufficientStokError (+7 more)

### Community 16 - "Backend 16"
Cohesion: 0.19
Nodes (6): NotifikasiViewSet, ViewSet untuk notifikasi in-app.      - Nasabah hanya melihat notifikasi milikny, Tandai satu notifikasi sebagai sudah dibaca., Tandai semua notifikasi user sebagai sudah dibaca., IsActivityReader, Nasabah (milik sendiri) atau staff read-all untuk riwayat gabungan.
...
Cohesion: 0.11
Nodes (23): AbstractUser, KategoriSampah, RiwayatHarga, User, TransaksiSetoranCreateSerializer, Decimal, KategoriSampah, User (+15 more)

### Community 21 - "Backend 21"
Cohesion: 0.25
Nodes (4): PenarikanSaldoSerializer, KategoriSampahViewSet, PenarikanSaldoViewSet, success_response()
...
Cohesion: 0.14
Nodes (10): Meta, TransaksiSetoranFilter, IsStaffManagerOrPetugas, IsUserOwnerOrAdmin, Object-level permission for the User model (/api/users/{id}/)., Admin, koordinator, atau petugas — untuk lookup nasabah., ActivityListView, AuditLogListView (+2 more)
...
Cohesion: 0.14
Nodes (14): Pengumuman, IsAdmin, PengaturanInstitusiSerializer, PengumumanSerializer, InstitutionSettingsView, PengumumanListView, PrivacyPolicyView, GET public — profil institusi. PATCH admin only. (+6 more)
...
Cohesion: 0.25
Nodes (3): HealthCheckView, OpenAPI / drf-spectacular configuration helpers., NotifikasiSerializer
...
Cohesion: 0.16
Nodes (10): AnonRateThrottle, LoginAnonRateThrottle, Custom DRF throttle classes for MIRU Bank Sampah API.  Rate limits: - Login endp, 10 requests per minute untuk endpoint login (anonymous)., LoginRateLimitTests, Tests for rate limiting (Fase 7.1 — Keamanan API).  Rate limits: - Login endpoin, Verifikasi throttle class terpasang di endpoint login., MiruTokenObtainPairView memiliki throttle_classes. (+2 more)

### Community 146 - "Community 146"
Cohesion: 0.23
Nodes (9): JSONRenderer, EnvelopeJSONRenderer, Wraps all DRF JSON responses in the standard MIRU envelope., build_meta(), error_envelope(), error_response(), get_action_message(), get_request_id() (+1 more)

### Community 147 - "Community 147"
Cohesion: 0.22
Nodes (6): AuditLogSerializer, RiwayatHargaSerializer, PageNumberPagination, get_price_history(), Return price history queryset for a category., MiruPagination

### Community 148 - "Community 148"
Cohesion: 0.17
Nodes (7): IsNasabah, IsOwnerOrAdmin, IsPickupManager, PenukaranPoinSerializer, PenukaranPoinViewSet, complete_penukaran_poin(), Atomically debit poin and decrease reward stock on redemption approval.
...
Cohesion: 0.50
Nodes (5): Reward, decrease_reward_stok(), _ensure_non_negative_reward_stok(), _lock_reward(), Decrease reward stock; raises if result would be negative.
...
## Knowledge Gaps
- **506 isolated node(s):** `Cakupan 17 Modul Backend`, `7.1 Keamanan API & Konfigurasi`, `7.2 Deployment`, `7.3 Backup & Recovery`, `7.4 Monitoring & Logging` (+501 more)
...
- **Why does `EnvelopeAPITestCase` connect `Tests 8` to `Tests`, `Tests 11`, `Tests 12`, `Tests 13`, `Backend 14`, `Tests 19`, `Community 151`, `Tests 23`, `Tests 26`, `Tests 27`, `Community 155`, `Community 156`, `Community 158`, `Community 161`, `Community 162`, `Tests 36`, `Tests 37`, `Tests 38`, `Tests 39`, `Backend 40`, `Tests 46`, `Backend 50`, `Tests 54`, `Backend 63`, `Backend 75`, `Community 118`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `KategoriSampah` connect `Services 20` to `Services`, `Tests`, `Tests 12`, `Tests 13`, `Services 15`, `Community 151`, `Tests 27`, `Community 155`, `Community 157`, `Community 158`, `Tests 36`, `Tests 38`, `Community 167`, `Tests 39`, `Backend 40`, `Backend 50`, `Tests 54`, `Backend 62`, `Community 118`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `TransaksiSetoran` connect `Tests` to `Services`, `Tests 36`, `Community 167`, `Tests 39`, `Community 158`, `Backend 40`, `Tests 12`, `Tests 13`, `Services 15`, `Backend 50`, `Services 20`, `Community 155`, `Backend 29`, `Backend 62`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Are the 54 inferred relationships involving `EnvelopeAPITestCase` (e.g. with `ActivityListTests` and `AuditLogListTests`) actually correct?**
  _`EnvelopeAPITestCase` has 54 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 42 inferred relationships involving `AlreadyProcessedError` (e.g. with `AuditLogSerializer` and `DetailSetoranReadSerializer`) actually correct?**
  _`AlreadyProcessedError` has 42 INFERRED edges - model-reasoned connections that need verification._
- **What connects `Cakupan 17 Modul Backend`, `7.1 Keamanan API & Konfigurasi`, `7.2 Deployment` to the rest of the system?**
