...
## Corpus Check
- 119 files · ~63,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1574 nodes · 2939 edges · 160 communities (67 shown, 93 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 520 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3b56eab`
...
- [[_COMMUNITY_Urutan Pengerjaan Rekomendasi (Sprint)|Urutan Pengerjaan Rekomendasi (Sprint)]]
...
- [[_COMMUNITY_InstitutionSettingsTests|InstitutionSettingsTests]]
- [[_COMMUNITY_PriceHistoryTests|PriceHistoryTests]]
...
- [[_COMMUNITY_Fase 6 Kualitas & Dokumentasi|Fase 6: Kualitas & Dokumentasi]]
- [[_COMMUNITY_Fase 8 Post-MVP & Peningkatan|Fase 8: Post-MVP & Peningkatan]]
- [[_COMMUNITY_get_privacy_policy|get_privacy_policy]]
...
- [[_COMMUNITY_Constraint No GPS Live Tracking|Constraint: No GPS Live Tracking]]
- [[_COMMUNITY_Constraint No Payment Gateway Integration|Constraint: No Payment Gateway Integration]]
- [[_COMMUNITY_AuditLog Model|AuditLog Model]]
...
Cohesion: 0.08
Nodes (45): AbstractUser, DetailSetoran, User, PenjualanMitraCreateSerializer, adjust_setoran_correction(), complete_penukaran_poin(), create_setoran_with_side_effects(), credit_nasabah_setoran() (+37 more)
...
### Community 2 - "Backend"
Cohesion: 0.07
Nodes (31): MeView, MiruTokenObtainPairSerializer, MiruTokenObtainPairView, MiruTokenRefreshView, user_auth_payload(), _envelope(), get_demo_user(), get_nav_groups() (+23 more)

### Community 3 - "Backend 3"
Cohesion: 0.14
Nodes (11): AuditLog, KategoriSampah, Meta, MitraPengepul, Pengaduan, Penjemputan, PenjualanMitra, Signal handlers for automatic AuditLog recording.  Uses pre_save to capture old (+3 more)

### Community 4 - "Tests"
Cohesion: 0.10
Nodes (10): PenarikanSaldo, PenukaranPoin, Reward, DashboardDepositChartTests, DashboardOverviewTests, DashboardRecentActivityTests, DashboardTestMixin, SOP A.4 — action endpoint approve. (+2 more)

### Community 6 - "Tests 6"
Cohesion: 0.12
Nodes (7): TransaksiSetoran, DailyReportTests, EvaluationReportTests, MonthlyReportTests, ReportTestMixin, WasteReportTests, WeeklyReportTests

### Community 7 - "Backend 7"
Cohesion: 0.07
Nodes (31): CurrentRequestMiddleware, get_client_ip(), get_current_request(), get_current_user(), Get the current user from thread-local storage., Extract client IP from request headers., Store the current request in thread-local storage., Access the current request from thread-local storage (for signals etc.). (+23 more)
...
Cohesion: 0.12
Nodes (16): AlreadyProcessedError, OpenAPI / drf-spectacular configuration helpers., AuditLogSerializer, DetailSetoranReadSerializer, DetailSetoranSerializer, DetailSetoranWriteSerializer, Meta, MitraPengepulSerializer (+8 more)

### Community 10 - "Backend 10"
Cohesion: 0.05
Nodes (43): Meta, TransaksiSetoranFilter, IsActivityReader, IsAdmin, IsAdminOrKoordinator, IsMonitorReadOnly, IsNasabah, IsOwnerOrAdmin (+35 more)

### Community 14 - "Backend 14"
Cohesion: 0.18
Nodes (11): PengaturanInstitusiSerializer, PengumumanSerializer, get_privacy_policy(), Kebijakan data pribadi (UU PDP) — konten untuk API publik., get_institution_settings(), Return the singleton institution settings row (creates defaults if missing)., InstitutionSettingsView, PengumumanListView (+3 more)

### Community 15 - "Services 15"
Cohesion: 0.13
Nodes (14): InvalidStatusTransitionError, PenjemputanUpdateSerializer, PickupAssignSerializer, PickupStatusActionSerializer, approve_pickup(), assign_pickup(), Decimal, Pickup request validation and status state machine. (+6 more)

### Community 16 - "Backend 16"
Cohesion: 0.24
Nodes (4): NotifikasiViewSet, ViewSet untuk notifikasi in-app.      - Nasabah hanya melihat notifikasi milikny, Tandai satu notifikasi sebagai sudah dibaca., Tandai semua notifikasi user sebagai sudah dibaca.

### Community 17 - "Backend 17"
Cohesion: 0.17
Nodes (11): get_activity_items(), _penarikan_items(), _penukaran_items(), Merged transaction history for nasabah activity feed., _resolve_nasabah_filter(), _setoran_items(), _types_for_jenis(), get_price_history() (+3 more)
...
Cohesion: 0.31
Nodes (12): approve_withdrawal(), _ensure_pending(), Decimal, Business rules for saldo withdrawal requests., Tolak pengajuan — saldo tidak pernah didebit saat create, jadi tidak perlu refun, reject_withdrawal(), validate_approve_withdrawal(), validate_create_withdrawal() (+4 more)
...
Cohesion: 0.29
Nodes (3): PengaturanInstitusi, Singleton — profil institusi bank sampah (pk selalu 1)., Institution settings singleton helpers.
...
Cohesion: 0.29
Nodes (3): PenjemputanCreateSerializer, validate_jadwal_h_plus_one(), validate_nasabah_owner()
...
Cohesion: 0.33
Nodes (3): SeedDataFullTests, SeedDataMinimalTests, TestCase
...
Cohesion: 0.23
Nodes (8): NotifikasiAdmin, PengaturanInstitusiAdmin, PengumumanAdmin, RiwayatHargaAdmin, Notifikasi, Pengumuman, In-app notification untuk user nasabah., RiwayatHarga
...
## Knowledge Gaps
- **469 isolated node(s):** `Migration`, `Meta`, `Notifikasi`, `Migration`, `Migration` (+464 more)
...
- **Why does `EnvelopeAPITestCase` connect `Tests 8` to `Backend 3`, `Tests`, `Tests 6`, `Tests 11`, `Tests 12`, `Tests 13`, `Tests 19`, `Tests 23`, `Tests 26`, `Tests 27`, `Community 156`, `Backend 29`, `Community 157`, `Community 155`, `Community 158`, `Tests 34`, `Tests 35`, `Tests 36`, `Tests 37`, `Tests 38`, `Tests 39`, `Backend 40`, `Tests 43`, `Tests 44`, `Tests 45`, `Tests 46`, `Tests 47`, `Tests 51`, `Tests 54`, `PenukaranPoinViewSet`, `InstitutionSettingsTests`, `PriceHistoryTests`, `MeEndpointTests`, `AdminCreateStaffTests`, `get_privacy_policy`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `KategoriSampah` connect `Backend 3` to `Services`, `Services 1`, `Tests`, `Tests 6`, `Backend 7`, `Tests 13`, `Tests 19`, `Services 20`, `Tests 23`, `Tests 26`, `Community 156`, `Community 157`, `Backend 29`, `Community 158`, `Tests 34`, `Tests 35`, `Backend 40`, `Tests 44`, `Backend 50`, `Tests 51`, `Backend 62`, `PenukaranPoinViewSet`, `PriceHistoryTests`, `get_privacy_policy`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `TransaksiSetoran` connect `Tests 6` to `Services`, `Services 1`, `Backend 3`, `Tests`, `Backend 40`, `Backend 10`, `Tests 44`, `Tests 13`, `Backend 17`, `Tests 51`, `Tests 19`, `Community 157`, `Tests 23`, `Tests 26`, `Community 156`, `Backend 29`, `Backend 62`, `PenukaranPoinViewSet`?**
