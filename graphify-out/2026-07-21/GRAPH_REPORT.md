...
## Corpus Check
- 147 files · ~81,210 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2043 nodes · 3816 edges · 194 communities (96 shown, 98 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 852 edges (avg confidence: 0.52)
...
## Communities (194 total, 98 thin omitted)

### Community 0 - "Services"
Cohesion: 0.15
Nodes (13): User, adjust_setoran_correction(), credit_nasabah_setoran(), debit_nasabah_poin(), debit_nasabah_saldo(), _ensure_non_negative_poin(), InsufficientPoinError, _lock_user() (+5 more)
...
### Community 2 - "Backend"
Cohesion: 0.11
Nodes (32): AbstractUser, AnonRateThrottle, ForgotPasswordView, MeView, MiruTokenObtainPairSerializer, MiruTokenObtainPairView, MiruTokenRefreshView, PoinInfoView (+24 more)
...
### Community 4 - "Tests"
Cohesion: 0.16
Nodes (5): Pengaduan, DashboardDepositChartTests, DashboardOverviewTests, DashboardRecentActivityTests, DashboardTestMixin
...
Cohesion: 0.14
Nodes (18): Decimal, KategoriSampah, Decimal, KategoriSampah, User, RiwayatHarga, build_detail_data(), prepare_details_data() (+10 more)
...
Cohesion: 0.07
Nodes (21): Device token (FCM) registration endpoints — Fase 8.6., _export_schema(), OpenAPI / drf-spectacular configuration helpers., DetailSetoranReadSerializer, DetailSetoranSerializer, DetailSetoranWriteSerializer, KontenEdukasiPublicSerializer, Meta (+13 more)
...
Cohesion: 0.11
Nodes (9): NotifikasiViewSet, ViewSet untuk notifikasi in-app.      - Nasabah hanya melihat notifikasi milikny, Tandai satu notifikasi sebagai sudah dibaca., Tandai semua notifikasi user sebagai sudah dibaca., IsActivityReader, IsPemerintahReadOnly, Pemerintah distrik: hanya boleh akses read (GET/HEAD/OPTIONS)., Nasabah (milik sendiri) atau staff read-all untuk riwayat gabungan. (+1 more)

### Community 17 - "Backend 17"
Cohesion: 0.18
Nodes (24): DetailSetoran, Reward, Decimal, KategoriSampah, Reward, complete_penukaran_poin(), create_setoran_with_side_effects(), decrease_kategori_stok() (+16 more)
...
Cohesion: 0.29
Nodes (4): TransaksiSetoranCreateSerializer, User, validate_nasabah_for_setoran(), validate_petugas_for_setoran()
...
Cohesion: 0.08
Nodes (30): CurrentRequestMiddleware, get_client_ip(), get_current_request(), get_current_user(), Access the current request from thread-local storage (for signals etc.)., Get the current user from thread-local storage., Extract client IP from request headers., Store the current request in thread-local storage. (+22 more)
...
Cohesion: 0.15
Nodes (13): IsAdmin, PengaturanInstitusiSerializer, PengumumanSerializer, InstitutionSettingsView, PengumumanListView, PrivacyPolicyView, GET public — profil institusi. PATCH admin only., PengaturanInstitusi (+5 more)
...
Cohesion: 0.07
Nodes (39): Any, _notif_penarikan(), _notif_pengaduan(), _notif_pengumuman(), _notif_penjemputan(), _notif_penukaran(), _notif_setoran(), Signal handlers for automatic Notifikasi generation.  Triggers on key business e (+31 more)
...
Cohesion: 0.09
Nodes (11): AlreadyProcessedError, KategoriSampahSerializer, PenarikanSaldoCreateSerializer, PenarikanSaldoUpdateSerializer, PenukaranPoinUpdateSerializer, Backward-compatible alias used by admin views., Admin-only: koreksi data transaksi setoran., RewardSerializer (+3 more)

### Community 146 - "Community 146"
Cohesion: 0.07
Nodes (26): DeviceTokenViewSet, Register / unregister FCM device tokens.      - POST   /api/device-tokens/, DELETE by token string (body) — praktis dari mobile logout., DeviceTokenSerializer, Decimal, HttpResponse, JSONRenderer, _format_rupiah() (+18 more)

### Community 147 - "Community 147"
Cohesion: 0.14
Nodes (3): IsAdminOrKoordinator, KategoriSampahViewSet, MitraPengepulViewSet

### Community 148 - "Community 148"
Cohesion: 0.17
Nodes (6): IsNasabah, IsOwnerOrAdmin, IsPetugasOrAdmin, IsPickupManager, PenukaranPoinSerializer, PenukaranPoinViewSet

### Community 151 - "Community 151"
Cohesion: 0.11
Nodes (14): 100 requests per hour untuk write operations per user.      GET/HEAD/OPTIONS tid, WriteUserRateThrottle, LoginRateLimitTests, Tests for rate limiting (Fase 7.1 — Keamanan API).  Rate limits: - Login endpoin, Verifikasi throttle class terpasang di endpoint login., MiruTokenObtainPairView memiliki throttle_classes., Scope login memiliki rate 10/minute., Login throttle mechanism berjalan tanpa error (tidak 500). (+6 more)

### Community 155 - "Community 155"
Cohesion: 0.17
Nodes (21): InvalidStatusTransitionError, PenjemputanUpdateSerializer, PickupAssignSerializer, Decimal, User, Penjemputan, approve_pickup(), assign_pickup() (+13 more)

### Community 158 - "Community 158"
Cohesion: 0.06
Nodes (68): date, datetime, fmt(), penarikan_total(), penukaran_count(), Shared aggregation helpers for dashboard and report endpoints., Format a Decimal/number as a fixed 2-decimal string ('0.00' for None)., Total berat (kg) and nilai (Rp) grouped per kategori for a period. (+60 more)

### Community 163 - "Community 163"
Cohesion: 0.22
Nodes (5): PenarikanSaldo, PenukaranPoin, User, KoordinatorAccessTests, PetugasAccessTests
...
Cohesion: 0.42
Nodes (9): CharInFilter, Meta, PenjemputanFilter, Supports ?status=menunggu and ?status__in=disetujui,dijadwalkan,..., TransaksiSetoranFilter, Penjemputan, TransaksiSetoran, ActivityListView (+1 more)

### Community 177 - "Community 177"
Cohesion: 0.32
Nodes (4): KategoriSampah, TestCase, SeedDataFullTests, SeedDataMinimalTests
...
- **Why does `EnvelopeAPITestCase` connect `Tests 8` to `Tests`, `Tests 11`, `Tests 12`, `Tests 13`, `Backend 14`, `Tests 19`, `Backend 21`, `Community 151`, `Tests 23`, `Tests 26`, `Tests 27`, `Community 156`, `Community 161`, `Community 162`, `Community 163`, `Tests 36`, `Tests 37`, `Tests 38`, `Tests 39`, `Backend 40`, `Community 167`, `Tests 46`, `Community 175`, `Community 176`, `Backend 50`, `Community 179`, `Tests 54`, `Community 189`, `Community 190`, `Community 191`, `Community 192`, `Backend 63`, `Backend 75`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `KategoriSampah` connect `Community 177` to `Services`, `Tests`, `Backend 7`, `Tests 12`, `Tests 13`, `Backend 14`, `Services 15`, `Backend 17`, `Services 20`, `Backend 21`, `Community 151`, `Tests 27`, `Community 157`, `Community 163`, `Tests 36`, `Tests 38`, `Tests 39`, `Backend 40`, `Backend 50`, `Tests 54`, `Community 189`, `Backend 62`, `Community 191`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `TransaksiSetoran` connect `Community 174` to `Services`, `Backend`, `Community 163`, `Tests`, `Tests 36`, `Tests 39`, `Backend 40`, `Backend 73`, `Tests 12`, `Tests 13`, `Backend 14`, `Backend 17`, `Backend 50`, `Backend 21`, `Community 158`, `Community 189`, `Backend 62`?**
